...
`,Ql=/(.+)!([^/]+)\/?([isu]+)?/,be=null,To=null,Ue=class t{static build(e,n){return Co(n),To(e,n,r=>new t(be.new(e,r,n)))}static enumerateMethods(e,n,r){Co(r);let o=e.match(Ql);if(o===null)throw new Error("Invalid query; format is: class!method -- see documentation of Java.enumerateMethods(query) for details");let s=Memory.allocUtf8String(o[1]),i=Memory.allocUtf8String(o[2]),c=!1,a=!1,l=!1,d=o[3];d!==void 0&&(c=d.indexOf("s")!==-1,a=d.indexOf("i")!==-1,l=d.indexOf("u")!==-1);let p;if(n.flavor==="jvm"){let f=be.enumerateMethodsJvm(s,i,We(c),We(a),We(l),r,n.jvmti);try{p=JSON.parse(f.readUtf8String()).map(u=>{let _=ptr(u.loader);return u.loader=_.isNull()?null:_,u})}finally{be.dealloc(f)}}else Ee(r.vm,r,f=>{let u=be.enumerateMethodsArt(s,i,We(c),We(a),We(l));try{let _=n["art::JavaVMExt::AddGlobalRef"],{vm:h}=n;p=JSON.parse(u.readUtf8String()).map(g=>{let b=g.loader;return g.loader=b!==0?_(h,f,ptr(b)):null,g})}finally{be.dealloc(u)}});return p}constructor(e){this.handle=e}has(e){return be.has(this.handle,Memory.allocUtf8String(e))!==0}find(e){return be.find(this.handle,Memory.allocUtf8String(e)).readUtf8String()}list(){let e=be.list(this.handle);try{return JSON.parse(e.readUtf8String())}finally{be.dealloc(e)}}};function Co(t){be===null&&(be=Yl(t),To=Xl(be,t.vm))}function Yl(t){let{pointerSize:e}=Process,n=8,r=e,o=6*e,s=10*4+5*e,i=n+r+o+s,a=Memory.alloc(i),l=a.add(n),d=l.add(r),{getDeclaredMethods:p,getDeclaredFields:f}=t.javaLangClass(),u=t.javaLangReflectMethod(),_=t.javaLangReflectField(),h=d;[p,f,u.getName,u.getModifiers,_.getName,_.getModifiers].forEach(M=>{h=h.writePointer(M).add(e)});let g=d.add(o),{vm:b}=t,S=Dn(b);if(S!==null){let M=S.offset,N=Ie(b),P=Un(b),E=g;[1,M.ifields,M.methods,M.sfields,M.copiedMethodsOffset,N.size,N.offset.accessFlags,P.size,P.offset.accessFlags,4294967295].forEach(O=>{E=E.writeUInt(O).add(4)});let L=J();[L.artClassLinker.address,L["art::ClassLinker::VisitClasses"],L["art::mirror::Class::GetDescriptor"],L["art::ArtMethod::PrettyMethod"],Process.getModuleByName("libc.so").getExportByName("free")].forEach((O,w)=>{O===void 0&&(O=NULL),E=E.writePointer(O).add(e)})}let I=new CModule(Kl,{lock:a,models:l,java_api:d,art_api:g}),A={exceptions:"propagate"},k={exceptions:"propagate",scheduling:"exclusive"};return{handle:I,mode:S!==null?"full":"basic",new:new NativeFunction(I.model_new,"pointer",["pointer","pointer","pointer"],A),has:new NativeFunction(I.model_has,"bool",["pointer","pointer"],k),find:new NativeFunction(I.model_find,"pointer",["pointer","pointer"],k),list:new NativeFunction(I.model_list,"pointer",["pointer"],k),enumerateMethodsArt:new NativeFunction(I.enumerate_methods_art,"pointer",["pointer","pointer","bool","bool","bool"],A),enumerateMethodsJvm:new NativeFunction(I.enumerate_methods_jvm,"pointer",["pointer","pointer","bool","bool","bool","pointer","pointer"],A),dealloc:new NativeFunction(I.dealloc,"void",["pointer"],k)}}function Xl(t,e){if(t.mode==="basic")return ed;let n=J()["art::JavaVMExt::DecodeGlobal"];return function(r,o,s){let i;return Ee(e,o,c=>{let a=n(e,c,r);i=s(a)}),i}}function ed(t,e,n){return n(NULL)}function We(t){return t?1:0}var pt=class{constructor(e,n){this.items=new Map,this.capacity=e,this.destroy=n}dispose(e){let{items:n,destroy:r}=this;n.forEach(o=>{r(o,e)}),n.clear()}get(e){let{items:n}=this,r=n.get(e);return r!==void 0&&(n.delete(e),n.set(e,r)),r}set(e,n,r){let{items:o}=this,s=o.get(e);if(s!==void 0)o.delete(e),this.destroy(s,r);else if(o.size===this.capacity){let i=o.keys().next().value,c=o.get(i);o.delete(i),this.destroy(c,r)}o.set(e,n)}};var ft=1,nr=256,xo=65536,td=305419896,Lo=32,Ao=12,No=8,ko=8,Mo=4,Oo=4,Ro=12,nd=0,rd=1,od=2,sd=3,id=4,ad=5,cd=6,ld=4096,dd=4097,ud=4099,pd=8192,fd=8193,hd=8194,_d=8195,md=8196,gd=8198,bd=24,yd=28,Ed=2,vd=24,Po=m.from([3,0,7,14,0]),er="Ldalvik/annotation/Throws;",Sd=m.from([0]);function wd(t){let e=new rr,n=Object.assign({},t);return e.addClass(n),e.build()}var rr=class{constructor(){this.classes=[]}addClass(e){this.classes.push(e)}build(){let e=Td(this.classes),{classes:n,interfaces:r,fields:o,methods:s,protos:i,parameters:c,annotationDirectories:a,annotationSets:l,throwsAnnotations:d,types:p,strings:f}=e,u=0,_=0,h=8,g=12,b=20,S=112;u+=S;let I=u,A=f.length*Oo;u+=A;let k=u,M=p.length*Mo;u+=M;let N=u,P=i.length*Ao;u+=P;let E=u,L=o.length*No;u+=L;let O=u,w=s.length*ko;u+=w;let R=u,D=n.length*Lo;u+=D;let U=u,F=l.map(T=>{let j=u;return T.offset=j,u+=4+T.items.length*4,j}),V=n.reduce((T,j)=>(j.classData.constructorMethods.forEach(H=>{let[,W,Z]=H;(W&nr)===0&&Z>=0&&(H.push(u),T.push({offset:u,superConstructor:Z}),u+=vd)}),T),[]);a.forEach(T=>{T.offset=u,u+=16+T.methods.length*8});let X=r.map(T=>{u=tr(u,4);let j=u;return T.offset=j,u+=4+2*T.types.length,j}),te=c.map(T=>{u=tr(u,4);let j=u;return T.offset=j,u+=4+2*T.types.length,j}),ie=[],Q=f.map(T=>{let j=u,B=m.from(_e(T.length)),H=m.from(T,"utf8"),W=m.concat([B,H,Sd]);return ie.push(W),u+=W.length,j}),oe=V.map(T=>{let j=u;return u+=Po.length,j}),Y=d.map(T=>{let j=Cd(T);return T.offset=u,u+=j.length,j}),ne=n.map((T,j)=>{T.classData.offset=u;let B=Id(T);return u+=B.length,B}),ve=0,Ye=0;u=tr(u,4);let $=u,he=r.length+c.length,Te=4+(o.length>0?1:0)+2+l.length+V.length+a.length+(he>0?1:0)+1+oe.length+d.length+n.length+1,Re=4+Te*Ro;u+=Re;let Ne=u-U,ze=u,C=m.alloc(ze);C.write(`dex
035`),C.writeUInt32LE(ze,32),C.writeUInt32LE(S,36),C.writeUInt32LE(td,40),C.writeUInt32LE(ve,44),C.writeUInt32LE(Ye,48),C.writeUInt32LE($,52),C.writeUInt32LE(f.length,56),C.writeUInt32LE(I,60),C.writeUInt32LE(p.length,64),C.writeUInt32LE(k,68),C.writeUInt32LE(i.length,72),C.writeUInt32LE(N,76),C.writeUInt32LE(o.length,80),C.writeUInt32LE(o.length>0?E:0,84),C.writeUInt32LE(s.length,88),C.writeUInt32LE(O,92),C.writeUInt32LE(n.length,96),C.writeUInt32LE(R,100),C.writeUInt32LE(Ne,104),C.writeUInt32LE(U,108),Q.forEach((T,j)=>{C.writeUInt32LE(T,I+j*Oo)}),p.forEach((T,j)=>{C.writeUInt32LE(T,k+j*Mo)}),i.forEach((T,j)=>{let[B,H,W]=T,Z=N+j*Ao;C.writeUInt32LE(B,Z),C.writeUInt32LE(H,Z+4),C.writeUInt32LE(W!==null?W.offset:0,Z+8)}),o.forEach((T,j)=>{let[B,H,W]=T,Z=E+j*No;C.writeUInt16LE(B,Z),C.writeUInt16LE(H,Z+2),C.writeUInt32LE(W,Z+4)}),s.forEach((T,j)=>{let[B,H,W]=T,Z=O+j*ko;C.writeUInt16LE(B,Z),C.writeUInt16LE(H,Z+2),C.writeUInt32LE(W,Z+4)}),n.forEach((T,j)=>{let{interfaces:B,annotationsDirectory:H}=T,W=B!==null?B.offset:0,Z=H!==null?H.offset:0,Xe=0,me=R+j*Lo;C.writeUInt32LE(T.index,me),C.writeUInt32LE(T.accessFlags,me+4),C.writeUInt32LE(T.superClassIndex,me+8),C.writeUInt32LE(W,me+12),C.writeUInt32LE(T.sourceFileIndex,me+16),C.writeUInt32LE(Z,me+20),C.writeUInt32LE(T.classData.offset,me+24),C.writeUInt32LE(Xe,me+28)}),l.forEach((T,j)=>{let{items:B}=T,H=F[j];C.writeUInt32LE(B.length,H),B.forEach((W,Z)=>{C.writeUInt32LE(W.offset,H+4+Z*4)})}),V.forEach((T,j)=>{let{offset:B,superConstructor:H}=T,W=1,Z=1,Xe=1,me=0,mt=4;C.writeUInt16LE(W,B),C.writeUInt16LE(Z,B+2),C.writeUInt16LE(Xe,B+4),C.writeUInt16LE(me,B+6),C.writeUInt32LE(oe[j],B+8),C.writeUInt32LE(mt,B+12),C.writeUInt16LE(4208,B+16),C.writeUInt16LE(H,B+18),C.writeUInt16LE(0,B+20),C.writeUInt16LE(14,B+22)}),a.forEach(T=>{let j=T.offset,B=0,H=0,W=T.methods.length,Z=0;C.writeUInt32LE(B,j),C.writeUInt32LE(H,j+4),C.writeUInt32LE(W,j+8),C.writeUInt32LE(Z,j+12),T.methods.forEach((Xe,me)=>{let mt=j+16+me*8,[cs,ls]=Xe;C.writeUInt32LE(cs,mt),C.writeUInt32LE(ls.offset,mt+4)})}),r.forEach((T,j)=>{let B=X[j];C.writeUInt32LE(T.types.length,B),T.types.forEach((H,W)=>{C.writeUInt16LE(H,B+4+W*2)})}),c.forEach((T,j)=>{let B=te[j];C.writeUInt32LE(T.types.length,B),T.types.forEach((H,W)=>{C.writeUInt16LE(H,B+4+W*2)})}),ie.forEach((T,j)=>{T.copy(C,Q[j])}),oe.forEach(T=>{Po.copy(C,T)}),Y.forEach((T,j)=>{T.copy(C,d[j].offset)}),ne.forEach((T,j)=>{T.copy(C,n[j].classData.offset)}),C.writeUInt32LE(Te,$);let ae=[[nd,1,_],[rd,f.length,I],[od,p.length,k],[sd,i.length,N]];o.length>0&&ae.push([id,o.length,E]),ae.push([ad,s.length,O]),ae.push([cd,n.length,R]),l.forEach((T,j)=>{ae.push([ud,T.items.length,F[j]])}),V.forEach(T=>{ae.push([fd,1,T.offset])}),a.forEach(T=>{ae.push([gd,1,T.offset])}),he>0&&ae.push([dd,he,X.concat(te)[0]]),ae.push([hd,f.length,Q[0]]),oe.forEach(T=>{ae.push([_d,1,T])}),d.forEach(T=>{ae.push([md,1,T.offset])}),n.forEach(T=>{ae.push([pd,1,T.classData.offset])}),ae.push([ld,1,$]),ae.forEach((T,j)=>{let[B,H,W]=T,Z=$+4+j*Ro;C.writeUInt16LE(B,Z),C.writeUInt32LE(H,Z+4),C.writeUInt32LE(W,Z+8)});let yr=new Checksum("sha1");return yr.update(C.slice(g+b)),m.from(yr.getDigest()).copy(C,g),C.writeUInt32LE(Md(C,g),h),C}};function Id(t){let{instanceFields:e,constructorMethods:n,virtualMethods:r}=t.classData;return m.from([0].concat(_e(e.length)).concat(_e(n.length)).concat(_e(r.length)).concat(e.reduce((s,[i,c])=>s.concat(_e(i)).concat(_e(c)),[])).concat(n.reduce((s,[i,c,,a])=>s.concat(_e(i)).concat(_e(c)).concat(_e(a||0)),[])).concat(r.reduce((s,[i,c])=>s.concat(_e(i)).concat(_e(c)).concat([0]),[])))}function Cd(t){let{thrownTypes:e}=t;return m.from([Ed].concat(_e(t.type)).concat([1]).concat(_e(t.value)).concat([yd,e.length]).concat(e.reduce((n,r)=>(n.push(bd,r),n),[])))}function Td(t){let e=new Set,n=new Set,r={},o=[],s=[],i={},c=new Set,a=new Set;t.forEach(w=>{let{name:R,superClass:D,sourceFileName:U}=w;e.add("this"),e.add(R),n.add(R),e.add(D),n.add(D),e.add(U),w.interfaces.forEach(F=>{e.add(F),n.add(F)}),w.fields.forEach(F=>{let[V,X]=F;e.add(V),e.add(X),n.add(X),o.push([w.name,X,V])}),w.methods.some(([F])=>F==="<init>")||(w.methods.unshift(["<init>","V",[]]),c.add(R)),w.methods.forEach(F=>{let[V,X,te,ie=[],Q]=F;e.add(V);let oe=l(X,te),Y=null;if(ie.length>0){let ne=ie.slice();ne.sort(),Y=ne.join("|");let ve=i[Y];ve===void 0&&(ve={id:Y,types:ne},i[Y]=ve),e.add(er),n.add(er),ie.forEach(Ye=>{e.add(Ye),n.add(Ye)}),e.add("value")}if(s.push([w.name,oe,V,Y,Q]),V==="<init>"){a.add(R+"|"+oe);let ne=D+"|"+oe;c.has(R)&&!a.has(ne)&&(s.push([D,oe,V,null,0]),a.add(ne))}})});function l(w,R){let D=[w].concat(R),U=D.join("|");if(r[U]!==void 0)return U;e.add(w),n.add(w),R.forEach(V=>{e.add(V),n.add(V)});let F=D.map(kd).join("");return e.add(F),r[U]=[U,F,w,R],U}let d=Array.from(e);d.sort();let p=d.reduce((w,R,D)=>(w[R]=D,w),{}),f=Array.from(n).map(w=>p[w]);f.sort(jo);let u=f.reduce((w,R,D)=>(w[d[R]]=D,w),{}),_=Object.keys(r).map(w=>r[w]);_.sort(Ld);let h={},g=_.map(w=>{let[,R,D,U]=w,F;if(U.length>0){let V=U.join("|");F=h[V],F===void 0&&(F={types:U.map(X=>u[X]),offset:-1},h[V]=F)}else F=null;return[p[R],u[D],F]}),b=_.reduce((w,R,D)=>{let[U]=R;return w[U]=D,w},{}),S=Object.keys(h).map(w=>h[w]),I=o.map(w=>{let[R,D,U]=w;return[u[R],u[D],p[U]]});I.sort(Ad);let A=s.map(w=>{let[R,D,U,F,V]=w;return[u[R],b[D],p[U],F,V]});A.sort(Nd);let k=Object.keys(i).map(w=>i[w]).map(w=>({id:w.id,type:u[er],value:p.value,thrownTypes:w.types.map(R=>u[R]),offset:-1})),M=k.map(w=>({id:w.id,items:[w],offset:-1})),N=M.reduce((w,R,D)=>(w[R.id]=D,w),{}),P={},E=[],L=t.map(w=>{let R=u[w.name],D=ft,U=u[w.superClass],F,V=w.interfaces.map($=>u[$]);if(V.length>0){V.sort(jo);let $=V.join("|");F=P[$],F===void 0&&(F={types:V,offset:-1},P[$]=F)}else F=null;let X=p[w.sourceFileName],te=A.reduce(($,he,Te)=>{let[Re,Ne,ze,C,ae]=he;return Re===R&&$.push([Te,ze,C,Ne,ae]),$},[]),ie=null,Q=te.filter(([,,$])=>$!==null).map(([$,,he])=>[$,M[N[he]]]);Q.length>0&&(ie={methods:Q,offset:-1},E.push(ie));let oe=I.reduce(($,he,Te)=>{let[Re]=he;return Re===R&&$.push([Te>0?1:0,ft]),$},[]),Y=p["<init>"],ne=te.filter(([,$])=>$===Y).map(([$,,,he])=>{if(c.has(w.name)){let Te=-1,Re=A.length;for(let Ne=0;Ne!==Re;Ne++){let[ze,C,ae]=A[Ne];if(ze===U&&ae===Y&&C===he){Te=Ne;break}}return[$,ft|xo,Te]}else return[$,ft|xo|nr,-1]}),ve=xd(te.filter(([,$])=>$!==Y).map(([$,,,,he])=>[$,he|ft|nr]));return{index:R,accessFlags:D,superClassIndex:U,interfaces:F,sourceFileIndex:X,annotationsDirectory:ie,classData:{instanceFields:oe,constructorMethods:ne,virtualMethods:ve,offset:-1}}}),O=Object.keys(P).map(w=>P[w]);return{classes:L,interfaces:O,fields:I,methods:A,protos:g,parameters:S,annotationDirectories:E,annotationSets:M,throwsAnnotations:k,types:f,strings:d}}function xd(t){let e=0;return t.map(([n,r],o)=>{let s;return o===0?s=[n,r]:s=[n-e,r],e=n,s})}function jo(t,e){return t-e}function Ld(t,e){let[,,n,r]=t,[,,o,s]=e;if(n<o)return-1;if(n>o)return 1;let i=r.join("|"),c=s.join("|");return i<c?-1:i>c?1:0}function Ad(t,e){let[n,r,o]=t,[s,i,c]=e;return n!==s?n-s:o!==c?o-c:r-i}function Nd(t,e){let[n,r,o]=t,[s,i,c]=e;return n!==s?n-s:o!==c?o-c:r-i}function kd(t){let e=t[0];return e==="L"||e==="["?"L":t}function _e(t){if(t<=127)return[t];let e=[],n=!1;do{let r=t&127;t>>=7,n=t!==0,n&&(r|=128),e.push(r)}while(n);return e}function tr(t,e){let n=t%e;return n===0?t:t+e-n}function Md(t,e){let n=1,r=0,o=t.length;for(let s=e;s<o;s++)n=(n+t[s])%65521,r=(r+n)%65521;return(r<<16|n)>>>0}var Fo=wd;var Od=1,or=null,Do=null;function Uo(t){or=t}function sr(t,e,n){let r=qe(t);return r===null&&(t.indexOf("[")===0?r=ir(t,e,n):(t[0]==="L"&&t[t.length-1]===";"&&(t=t.substring(1,t.length-1)),r=Pd(t,e,n))),Object.assign({className:t},r)}var Bo={boolean:{name:"Z",type:"uint8",size:1,byteSize:1,defaultValue:!1,isCompatible(t){return typeof t=="boolean"},fromJni(t){return!!t},toJni(t){return t?1:0},read(t){return t.readU8()},write(t,e){t.writeU8(e)},toString(){return this.name}},byte:{name:"B",type:"int8",size:1,byteSize:1,defaultValue:0,isCompatible(t){return Number.isInteger(t)&&t>=-128&&t<=127},fromJni:ye,toJni:ye,read(t){return t.readS8()},write(t,e){t.writeS8(e)},toString(){return this.name}},char:{name:"C",type:"uint16",size:1,byteSize:2,defaultValue:0,isCompatible(t){if(typeof t!="string"||t.length!==1)return!1;let e=t.charCodeAt(0);return e>=0&&e<=65535},fromJni(t){return String.fromCharCode(t)},toJni(t){return t.charCodeAt(0)},read(t){return t.readU16()},write(t,e){t.writeU16(e)},toString(){return this.name}},short:{name:"S",type:"int16",size:1,byteSize:2,defaultValue:0,isCompatible(t){return Number.isInteger(t)&&t>=-32768&&t<=32767},fromJni:ye,toJni:ye,read(t){return t.readS16()},write(t,e){t.writeS16(e)},toString(){return this.name}},int:{name:"I",type:"int32",size:1,byteSize:4,defaultValue:0,isCompatible(t){return Number.isInteger(t)&&t>=-2147483648&&t<=2147483647},fromJni:ye,toJni:ye,read(t){return t.readS32()},write(t,e){t.writeS32(e)},toString(){return this.name}},long:{name:"J",type:"int64",size:2,byteSize:8,defaultValue:0,isCompatible(t){return typeof t=="number"||t instanceof Int64},fromJni:ye,toJni:ye,read(t){return t.readS64()},write(t,e){t.writeS64(e)},toString(){return this.name}},float:{name:"F",type:"float",size:1,byteSize:4,defaultValue:0,isCompatible(t){return typeof t=="number"},fromJni:ye,toJni:ye,read(t){return t.readFloat()},write(t,e){t.writeFloat(e)},toString(){return this.name}},double:{name:"D",type:"double",size:2,byteSize:8,defaultValue:0,isCompatible(t){return typeof t=="number"},fromJni:ye,toJni:ye,read(t){return t.readDouble()},write(t,e){t.writeDouble(e)},toString(){return this.name}},void:{name:"V",type:"void",size:0,byteSize:0,defaultValue:void 0,isCompatible(t){return t===void 0},fromJni(){},toJni(){return NULL},toString(){return this.name}}},Rd=new Set(Object.values(Bo).map(t=>t.name));function qe(t){let e=Bo[t];return e!==void 0?e:null}function Pd(t,e,n){let r=n._types[e?1:0],o=r[t];return o!==void 0||(t==="java.lang.Object"?o=jd(n):o=Fd(t,e,n),r[t]=o),o}function jd(t){return{name:"Ljava/lang/Object;",type:"pointer",size:1,defaultValue:NULL,isCompatible(e){return e===null?!0:e===void 0?!1:e.$h instanceof NativePointer?!0:typeof e=="string"},fromJni(e,n,r){return e.isNull()?null:t.cast(e,t.use("java.lang.Object"),r)},toJni(e,n){return e===null?NULL:typeof e=="string"?n.newStringUtf(e):e.$h}}}function Fd(t,e,n){let r=null,o=null,s=null;function i(){return r===null&&(r=n.use(t).class),r}function c(l){let d=i();return o===null&&(o=d.isInstance.overload("java.lang.Object")),o.call(d,l)}function a(){if(s===null){let l=i();s=n.use("java.lang.String").class.isAssignableFrom(l)}return s}return{name:Be(t),type:"pointer",size:1,defaultValue:NULL,isCompatible(l){return l===null?!0:l===void 0?!1:l.$h instanceof NativePointer?c(l):typeof l=="string"&&a()},fromJni(l,d,p){return l.isNull()?null:a()&&e?d.stringFromJni(l):n.cast(l,n.use(t),p)},toJni(l,d){return l===null?NULL:typeof l=="string"?d.newStringUtf(l):l.$h},toString(){return this.name}}}var Dd=[["Z","boolean"],["B","byte"],["C","char"],["D","double"],["F","float"],["I","int"],["J","long"],["S","short"]].reduce((t,[e,n])=>(t["["+e]=Ud("["+e,n),t),{});function Ud(t,e){let n=y.prototype,r=Gd(e),o={typeName:e,newArray:n["new"+r+"Array"],setRegion:n["set"+r+"ArrayRegion"],getElements:n["get"+r+"ArrayElements"],releaseElements:n["release"+r+"ArrayElements"]};return{name:t,type:"pointer",size:1,defaultValue:NULL,isCompatible(s){return Jd(s,e)},fromJni(s,i,c){return Vd(s,o,i,c)},toJni(s,i){return zd(s,o,i)}}}function ir(t,e,n){let r=Dd[t];if(r!==void 0)return r;if(t.indexOf("[")!==0)throw new Error("Unsupported type: "+t);let o=t.substring(1),s=sr(o,e,n),i=0,c=o.length;for(;i!==c&&o[i]==="[";)i++;o=o.substring(i),o[0]==="L"&&o[o.length-1]===";"&&(o=o.substring(1,o.length-1));let a=o.replace(/\./g,"/");Rd.has(a)?a="[".repeat(i)+a:a="[".repeat(i)+"L"+a+";";let l="["+a;return o="[".repeat(i)+o,{name:t.replace(/\./g,"/"),type:"pointer",size:1,defaultValue:NULL,isCompatible(d){return d===null?!0:typeof d!="object"||d.length===void 0?!1:d.every(function(p){return s.isCompatible(p)})},fromJni(d,p,f){if(d.isNull())return null;let u=[],_=p.getArrayLength(d);for(let h=0;h!==_;h++){let g=p.getObjectArrayElement(d,h);try{u.push(s.fromJni(g,p))}finally{p.deleteLocalRef(g)}}try{u.$w=n.cast(d,n.use(l),f)}catch{n.use("java.lang.reflect.Array").newInstance(n.use(o).class,0),u.$w=n.cast(d,n.use(l),f)}return u.$dispose=Bd,u},toJni(d,p){if(d===null)return NULL;if(!(d instanceof Array))throw new Error("Expected an array");let f=d.$w;if(f!==void 0)return f.$h;let u=d.length,h=n.use(o).$borrowClassHandle(p);try{let g=p.newObjectArray(u,h.value,NULL);p.throwIfExceptionPending();for(let b=0;b!==u;b++){let S=s.toJni(d[b],p);try{p.setObjectArrayElement(g,b,S)}finally{s.type==="pointer"&&p.getObjectRefType(S)===Od&&p.deleteLocalRef(S)}p.throwIfExceptionPending()}return g}finally{h.unref(p)}}}}function Bd(){let t=this.length;for(let e=0;e!==t;e++){let n=this[e];if(n===null)continue;let r=n.$dispose;if(r===void 0)break;r.call(n)}this.$w.$dispose()}function Vd(t,e,n,r){if(t.isNull())return null;let o=qe(e.typeName),s=n.getArrayLength(t);return new Ft(t,e,o,s,n,r)}function zd(t,e,n){if(t===null)return NULL;let r=t.$h;if(r!==void 0)return r;let o=t.length,s=qe(e.typeName),i=e.newArray.call(n,o);if(i.isNull())throw new Error("Unable to construct array");if(o>0){let c=s.byteSize,a=s.write,l=s.toJni,d=Memory.alloc(o*s.byteSize);for(let p=0;p!==o;p++)a(d.add(p*c),l(t[p]));e.setRegion.call(n,i,0,o,d),n.throwIfExceptionPending()}return i}function Jd(t,e){if(t===null)return!0;if(t instanceof Ft)return t.$s.typeName===e;if(!(typeof t=="object"&&t.length!==void 0))return!1;let r=qe(e);return Array.prototype.every.call(t,o=>r.isCompatible(o))}function Ft(t,e,n,r,o,s=!0){if(s){let i=o.newGlobalRef(t);this.$h=i,this.$r=Script.bindWeak(this,o.vm.makeHandleDestructor(i))}else this.$h=t,this.$r=null;return this.$s=e,this.$t=n,this.length=r,new Proxy(this,Do)}Do={has(t,e){return e in t?!0:t.tryParseIndex(e)!==null},get(t,e,n){let r=t.tryParseIndex(e);return r===null?t[e]:t.readElement(r)},set(t,e,n,r){let o=t.tryParseIndex(e);return o===null?(t[e]=n,!0):(t.writeElement(o,n),!0)},ownKeys(t){let e=[],{length:n}=t;for(let r=0;r!==n;r++){let o=r.toString();e.push(o)}return e.push("length"),e},getOwnPropertyDescriptor(t,e){return t.tryParseIndex(e)!==null?{writable:!0,configurable:!0,enumerable:!0}:Object.getOwnPropertyDescriptor(t,e)}};Object.defineProperties(Ft.prototype,{$dispose:{enumerable:!0,value(){let t=this.$r;t!==null&&(this.$r=null,Script.unbindWeak(t))}},$clone:{value(t){return new Ft(this.$h,this.$s,this.$t,this.length,t)}},tryParseIndex:{value(t){if(typeof t=="symbol")return null;let e=parseInt(t);return isNaN(e)||e<0||e>=this.length?null:e}},readElement:{value(t){return this.withElements(e=>{let n=this.$t;return n.fromJni(n.read(e.add(t*n.byteSize)))})}},writeElement:{value(t,e){let{$h:n,$s:r,$t:o}=this,s=or.getEnv(),i=Memory.alloc(o.byteSize);o.write(i,o.toJni(e)),r.setRegion.call(s,n,t,1,i)}},withElements:{value(t){let{$h:e,$s:n}=this,r=or.getEnv(),o=n.getElements.call(r,e);if(o.isNull())throw new Error("Unable to get array elements");try{return t(o)}finally{n.releaseElements.call(r,e,o)}}},toJSON:{value(){let{length:t,$t:e}=this,{byteSize:n,fromJni:r,read:o}=e;return this.withElements(s=>{let i=[];for(let c=0;c!==t;c++){let a=r(o(s.add(c*n)));i.push(a)}return i})}},toString:{value(){return this.toJSON().toString()}}});function Be(t){return"L"+t.replace(/\./g,"/")+";"}function Gd(t){return t.charAt(0).toUpperCase()+t.slice(1)}function ye(t){return t}var $d=4,{ensureClassInitialized:Vo,makeMethodMangler:Zo}=Pt,Hd=8,lr=1,_t=2,Ae=3,ar=1,dr=2,Dt=1,Wo=2,zo=Symbol("PENDING_USE"),Jo="/data/local/tmp",{getCurrentThreadId:Bt,pointerSize:ht}=Process,ue={state:"empty",factories:[],loaders:null,Integer:null},G=null,K=null,qo=null,Ko=null,Qo=null,Yo=null,Xo=null,Go=null,cr=null,Qe=new Map,Oe=class t{static _initialize(e,n){G=e,K=n,qo=n.flavor==="art",n.flavor==="jvm"&&(Vo=yo,Zo=vo)}static _disposeAll(e){ue.factories.forEach(n=>{n._dispose(e)})}static get(e){let n=pu(),r=n.factories[0];if(e===null)return r;let o=n.loaders.get(e);if(o!==null){let i=r.cast(o,n.Integer);return n.factories[i.intValue()]}let s=new t;return s.loader=e,s.cacheDir=r.cacheDir,fr(s,e),s}constructor(){this.cacheDir=Jo,this.codeCacheDir=Jo+"/dalvik-cache",this.tempFileNaming={prefix:"frida",suffix:""},this._classes={},this._classHandles=new pt(10,Wd),this._patchedMethods=new Set,this._loader=null,this._types=[{},{}],ue.factories.push(this)}_dispose(e){Array.from(this._patchedMethods).forEach(n=>{n.implementation=null}),this._patchedMethods.clear(),$n(),this._classHandles.dispose(e),this._classes={}}get loader(){return this._loader}set loader(e){let n=this._loader===null&&e!==null;this._loader=e,n&&ue.state==="ready"&&this===ue.factories[0]&&fr(this,e)}use(e,n={}){let r=n.cache!=="skip",o=r?this._getUsedClass(e):void 0;if(o===void 0)try{let s=G.getEnv(),{_loader:i}=this,c=i!==null?Kd(e,i,s):qd(e);o=this._make(e,c,s)}finally{r&&this._setUsedClass(e,o)}return o}_getUsedClass(e){let n;for(;(n=this._classes[e])===zo;)Thread.sleep(.05);return n===void 0&&(this._classes[e]=zo),n}_setUsedClass(e,n){n!==void 0?this._classes[e]=n:delete this._classes[e]}_make(e,n,r){let o=Zd(),s=Object.create(_r.prototype,{[Symbol.for("n")]:{value:e},$n:{get(){return this[Symbol.for("n")]}},[Symbol.for("C")]:{value:o},$C:{get(){return this[Symbol.for("C")]}},[Symbol.for("w")]:{value:null,writable:!0},$w:{get(){return this[Symbol.for("w")]},set(a){this[Symbol.for("w")]=a}},[Symbol.for("_s")]:{writable:!0},$_s:{get(){return this[Symbol.for("_s")]},set(a){this[Symbol.for("_s")]=a}},[Symbol.for("c")]:{value:[null]},$c:{get(){return this[Symbol.for("c")]}},[Symbol.for("m")]:{value:new Map},$m:{get(){return this[Symbol.for("m")]}},[Symbol.for("l")]:{value:null,writable:!0},$l:{get(){return this[Symbol.for("l")]},set(a){this[Symbol.for("l")]=a}},[Symbol.for("gch")]:{value:n},$gch:{get(){return this[Symbol.for("gch")]}},[Symbol.for("f")]:{value:this},$f:{get(){return this[Symbol.for("f")]}}});o.prototype=s;let i=new o(null);s[Symbol.for("w")]=i,s.$w=i;let c=i.$borrowClassHandle(r);try{let a=c.value;Vo(r,a),s.$l=Ue.build(a,r)}finally{c.unref(r)}return i}retain(e){let n=G.getEnv();return e.$clone(n)}cast(e,n,r){let o=G.getEnv(),s=e.$h;s===void 0&&(s=e);let i=n.$borrowClassHandle(o);try{if(!o.isInstanceOf(s,i.value))throw new Error(`Cast from '${o.getObjectClassName(s)}' to '${n.$n}' isn't possible`)}finally{i.unref(o)}let c=n.$C;return new c(s,Dt,o,r)}wrap(e,n,r){let o=n.$C,s=new o(e,Dt,r,!1);return s.$r=Script.bindWeak(s,G.makeHandleDestructor(e)),s}array(e,n){let r=G.getEnv(),o=qe(e);o!==null&&(e=o.name);let s=ir("["+e,!1,this),i=s.toJni(n,r);return s.fromJni(i,r,!0)}registerClass(e){let n=G.getEnv(),r=[];try{let o=this.use("java.lang.Class"),s=n.javaLangReflectMethod(),i=n.vaMethod("pointer",[]),c=e.name,a=e.implements||[],l=e.superClass||this.use("java.lang.Object"),d=[],p=[],f={name:Be(c),sourceFileName:hu(c),superClass:Be(l.$n),interfaces:a.map(E=>Be(E.$n)),fields:d,methods:p},u=a.slice();a.forEach(E=>{Array.prototype.slice.call(E.class.getInterfaces()).forEach(L=>{let O=this.cast(L,o).getCanonicalName();u.push(this.use(O))})});let _=e.fields||{};Object.getOwnPropertyNames(_).forEach(E=>{let L=this._getType(_[E]);d.push([E,L.name])});let h={},g={};u.forEach(E=>{let L=E.$borrowClassHandle(n);r.push(L);let O=L.value;E.$ownMembers.filter(w=>E[w].overloads!==void 0).forEach(w=>{let R=E[w],D=R.overloads,U=D.map(F=>$o(w,F.returnType,F.argumentTypes));h[w]=[R,U,O],D.forEach((F,V)=>{let X=U[V];g[X]=[F,O]})})});let b=e.methods||{},I=Object.keys(b).reduce((E,L)=>{let O=b[L],w=L==="$init"?"<init>":L;return O instanceof Array?E.push(...O.map(R=>[w,R])):E.push([w,O]),E},[]),A=[];I.forEach(([E,L])=>{let O=Ae,w,R,D=[],U;if(typeof L=="function"){let te=h[E];if(te!==void 0&&Array.isArray(te)){let[ie,Q,oe]=te;if(Q.length>1)throw new Error(`More than one overload matching '${E}': signature must be specified`);delete g[Q[0]];let Y=ie.overloads[0];O=Y.type,w=Y.returnType,R=Y.argumentTypes,U=L;let ne=n.toReflectedMethod(oe,Y.handle,0),ve=i(n.handle,ne,s.getGenericExceptionTypes);D=hr(n,ve).map(Be),n.deleteLocalRef(ve),n.deleteLocalRef(ne)}else w=this._getType("void"),R=[],U=L}else{if(L.isStatic&&(O=_t),w=this._getType(L.returnType||"void"),R=(L.argumentTypes||[]).map(Q=>this._getType(Q)),U=L.implementation,typeof U!="function")throw new Error("Expected a function implementation for method: "+E);let te=$o(E,w,R),ie=g[te];if(ie!==void 0){let[Q,oe]=ie;delete g[te],O=Q.type,w=Q.returnType,R=Q.argumentTypes;let Y=n.toReflectedMethod(oe,Q.handle,0),ne=i(n.handle,Y,s.getGenericExceptionTypes);D=hr(n,ne).map(Be),n.deleteLocalRef(ne),n.deleteLocalRef(Y)}}let F=w.name,V=R.map(te=>te.name),X="("+V.join("")+")"+F;p.push([E,F,V,D,O===_t?Hd:0]),A.push([E,X,O,w,R,U])});let k=Object.keys(g);if(k.length>0)throw new Error("Missing implementation for: "+k.join(", "));let M=Ut.fromBuffer(Fo(f),this);try{M.load()}finally{M.file.delete()}let N=this.use(e.name),P=I.length;if(P>0){let E=3*ht,L=Memory.alloc(P*E),O=[],w=[];A.forEach(([U,F,V,X,te,ie],Q)=>{let oe=Memory.allocUtf8String(U),Y=Memory.allocUtf8String(F),ne=es(U,N,V,X,te,ie);L.add(Q*E).writePointer(oe),L.add(Q*E+ht).writePointer(Y),L.add(Q*E+2*ht).writePointer(ne),w.push(oe,Y),O.push(ne)});let R=N.$borrowClassHandle(n);r.push(R);let D=R.value;n.registerNatives(D,L,P),n.throwIfExceptionPending(),N.$nativeMethods=O}return N}finally{r.forEach(o=>{o.unref(n)})}}choose(e,n){let r=G.getEnv(),{flavor:o}=K;if(o==="jvm")this._chooseObjectsJvm(e,r,n);else if(o==="art"){let s=K["art::gc::Heap::VisitObjects"]===void 0;if(s&&K["art::gc::Heap::GetInstances"]===void 0)return this._chooseObjectsJvm(e,r,n);Ee(G,r,i=>{s?this._chooseObjectsArtPreA12(e,r,i,n):this._chooseObjectsArtLegacy(e,r,i,n)})}else this._chooseObjectsDalvik(e,r,n)}_chooseObjectsJvm(e,n,r){let o=this.use(e),{jvmti:s}=K,i=1,c=3,a=o.$borrowClassHandle(n),l=int64(a.value.toString());try{let d=new NativeCallback((b,S,I,A)=>(I.writeS64(l),i),"int",["int64","int64","pointer","pointer"]);s.iterateOverInstancesOfClass(a.value,c,d,a.value);let p=Memory.alloc(8);p.writeS64(l);let f=Memory.alloc($d),u=Memory.alloc(ht);s.getObjectsWithTags(1,p,f,u,NULL);let _=f.readS32(),h=u.readPointer(),g=[];for(let b=0;b!==_;b++)g.push(h.add(b*ht).readPointer());s.deallocate(h);try{for(let b of g){let S=this.cast(b,o);if(r.onMatch(S)==="stop")break}r.onComplete()}finally{g.forEach(b=>{n.deleteLocalRef(b)})}}finally{a.unref(n)}}_chooseObjectsArtPreA12(e,n,r,o){let s=this.use(e),i=lt.$new(r,G),c,a=s.$borrowClassHandle(n);try{let f=K["art::JavaVMExt::DecodeGlobal"](K.vm,r,a.value);c=i.newHandle(f)}finally{a.unref(n)}let l=0,d=ct.$new();K["art::gc::Heap::GetInstances"](K.artHeap,i,c,l,d);let p=d.handles.map(f=>n.newGlobalRef(f));d.$delete(),i.$delete();try{for(let f of p){let u=this.cast(f,s);if(o.onMatch(u)==="stop")break}o.onComplete()}finally{p.forEach(f=>{n.deleteGlobalRef(f)})}}_chooseObjectsArtLegacy(e,n,r,o){let s=this.use(e),i=[],c=K["art::JavaVMExt::AddGlobalRef"],a=K.vm,l,d=s.$borrowClassHandle(n);try{l=K["art::JavaVMExt::DecodeGlobal"](a,r,d.value).toInt32()}finally{d.unref(n)}let p=Kn(l,f=>{i.push(c(a,r,f))});K["art::gc::Heap::VisitObjects"](K.artHeap,p,NULL);try{for(let f of i){let u=this.cast(f,s);if(o.onMatch(u)==="stop")break}}finally{i.forEach(f=>{n.deleteGlobalRef(f)})}o.onComplete()}_chooseObjectsDalvik(e,n,r){let o=this.use(e);if(K.addLocalReference===null){let i=Process.getModuleByName("libdvm.so"),c;switch(Process.arch){case"arm":c="2d e9 f0 41 05 46 15 4e 0c 46 7e 44 11 b3 43 68";break;case"ia32":c="8d 64 24 d4 89 5c 24 1c 89 74 24 20 e8 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 85 d2";break}Memory.scan(i.base,i.size,c,{onMatch:(a,l)=>{let d;if(Process.arch==="arm")a=a.or(1),d=new NativeFunction(a,"pointer",["pointer","pointer"]);else{let p=Memory.alloc(Process.pageSize);Memory.patchCode(p,16,f=>{let u=new X86Writer(f,{pc:p});u.putMovRegRegOffsetPtr("eax","esp",4),u.putMovRegRegOffsetPtr("edx","esp",8),u.putJmpAddress(a),u.flush()}),d=new NativeFunction(p,"pointer",["pointer","pointer"]),d._thunk=p}return K.addLocalReference=d,G.perform(p=>{s(this,p)}),"stop"},onError(a){},onComplete(){K.addLocalReference===null&&r.onComplete()}})}else s(this,n);function s(i,c){let{DVM_JNI_ENV_OFFSET_SELF:a}=Pt,l=c.handle.add(a).readPointer(),d,p=o.$borrowClassHandle(c);try{d=K.dvmDecodeIndirectRef(l,p.value)}finally{p.unref(c)}let f=d.toMatchPattern(),u=K.dvmHeapSourceGetBase(),h=K.dvmHeapSourceGetLimit().sub(u).toInt32();Memory.scan(u,h,f,{onMatch:(g,b)=>{K.dvmIsValidObject(g)&&G.perform(S=>{let I=S.handle.add(a).readPointer(),A,k=K.addLocalReference(I,g);try{A=i.cast(k,o)}finally{S.deleteLocalRef(k)}if(r.onMatch(A)==="stop")return"stop"})},onError(g){},onComplete(){r.onComplete()}})}}openClassFile(e){return new Ut(e,null,this)}_getType(e,n=!0){return sr(e,n,this)}};function Zd(){return function(t,e,n,r){return _r.call(this,t,e,n,r)}}function _r(t,e,n,r=!0){if(t!==null)if(r){let o=n.newGlobalRef(t);this.$h=o,this.$r=Script.bindWeak(this,G.makeHandleDestructor(o))}else this.$h=t,this.$r=null;else this.$h=null,this.$r=null;return this.$t=e,new Proxy(this,Ko)}Ko={has(t,e){return e in t?!0:t.$has(e)},get(t,e,n){if(typeof e!="string"||e.startsWith("$")||e==="class")return t[e];let r=t.$find(e);return r!==null?r(n):t[e]},set(t,e,n,r){return t[e]=n,!0},ownKeys(t){return t.$list()},getOwnPropertyDescriptor(t,e){return Object.prototype.hasOwnProperty.call(t,e)?Object.getOwnPropertyDescriptor(t,e):{writable:!1,configurable:!0,enumerable:!0}}};Object.defineProperties(_r.prototype,{[Symbol.for("new")]:{enumerable:!1,get(){return this.$getCtor("allocAndInit")}},$new:{enumerable:!0,get(){return this[Symbol.for("new")]}},[Symbol.for("alloc")]:{enumerable:!1,value(){let t=G.getEnv(),e=this.$borrowClassHandle(t);try{let n=t.allocObject(e.value);return this.$f.cast(n,this)}finally{e.unref(t)}}},$alloc:{enumerable:!0,get(){return this[Symbol.for("alloc")]}},[Symbol.for("init")]:{enumerable:!1,get(){return this.$getCtor("initOnly")}},$init:{enumerable:!0,get(){return this[Symbol.for("init")]}},[Symbol.for("dispose")]:{enumerable:!1,value(){let t=this.$r;t!==null&&(this.$r=null,Script.unbindWeak(t)),this.$h!==null&&(this.$h=void 0)}},$dispose:{enumerable:!0,get(){return this[Symbol.for("dispose")]}},[Symbol.for("clone")]:{enumerable:!1,value(t){let e=this.$C;return new e(this.$h,this.$t,t)}},$clone:{value(t){return this[Symbol.for("clone")](t)}},[Symbol.for("class")]:{enumerable:!1,get(){let t=G.getEnv(),e=this.$borrowClassHandle(t);try{let n=this.$f;return n.cast(e.value,n.use("java.lang.Class"))}finally{e.unref(t)}}},class:{enumerable:!0,get(){return this[Symbol.for("class")]}},[Symbol.for("className")]:{enumerable:!1,get(){let t=this.$h;return t===null?this.$n:G.getEnv().getObjectClassName(t)}},$className:{enumerable:!0,get(){return this[Symbol.for("className")]}},[Symbol.for("ownMembers")]:{enumerable:!1,get(){return this.$l.list()}},$ownMembers:{enumerable:!0,get(){return this[Symbol.for("ownMembers")]}},[Symbol.for("super")]:{enumerable:!1,get(){let t=G.getEnv(),e=this.$s.$C;return new e(this.$h,Wo,t)}},$super:{enumerable:!0,get(){return this[Symbol.for("super")]}},[Symbol.for("s")]:{enumerable:!1,get(){let t=Object.getPrototypeOf(this),e=t.$_s;if(e===void 0){let n=G.getEnv(),r=this.$borrowClassHandle(n);try{let o=n.getSuperclass(r.value);if(o.isNull())e=null;else try{let s=n.getClassName(o),i=t.$f;if(e=i._getUsedClass(s),e===void 0)try{let c=Qd(this);e=i._make(s,c,n)}finally{i._setUsedClass(s,e)}}finally{n.deleteLocalRef(o)}}finally{r.unref(n)}t.$_s=e}return e}},$s:{get(){return this[Symbol.for("s")]}},[Symbol.for("isSameObject")]:{enumerable:!1,value(t){return G.getEnv().isSameObject(t.$h,this.$h)}},$isSameObject:{value(t){return this[Symbol.for("isSameObject")](t)}},[Symbol.for("getCtor")]:{enumerable:!1,value(t){let e=this.$c,n=e[0];if(n===null){let r=G.getEnv(),o=this.$borrowClassHandle(r);try{n=Yd(o.value,this.$w,r),e[0]=n}finally{o.unref(r)}}return n[t]}},$getCtor:{value(t){return this[Symbol.for("getCtor")](t)}},[Symbol.for("borrowClassHandle")]:{enumerable:!1,value(t){let e=this.$n,n=this.$f._classHandles,r=n.get(e);return r===void 0&&(r=new mr(this.$gch(t),t),n.set(e,r,t)),r.ref()}},$borrowClassHandle:{value(t){return this[Symbol.for("borrowClassHandle")](t)}},[Symbol.for("copyClassHandle")]:{enumerable:!1,value(t){let e=this.$borrowClassHandle(t);try{return t.newLocalRef(e.value)}finally{e.unref(t)}}},$copyClassHandle:{value(t){return this[Symbol.for("copyClassHandle")](t)}},[Symbol.for("getHandle")]:{enumerable:!1,value(t){let e=this.$h;if(e===void 0)throw new Error("Wrapper is disposed; perhaps it was borrowed from a hook instead of calling Java.retain() to make a long-lived wrapper?");return e}},$getHandle:{value(t){return this[Symbol.for("getHandle")](t)}},[Symbol.for("list")]:{enumerable:!1,value(){let t=this.$s,e=t!==null?t.$list():[],n=this.$l;return Array.from(new Set(e.concat(n.list())))}},$list:{get(){return this[Symbol.for("list")]}},[Symbol.for("has")]:{enumerable:!1,value(t){if(this.$m.has(t)||this.$l.has(t))return!0;let r=this.$s;return!!(r!==null&&r.$has(t))}},$has:{value(t){return this[Symbol.for("has")](t)}},[Symbol.for("find")]:{enumerable:!1,value(t){let e=this.$m,n=e.get(t);if(n!==void 0)return n;let o=this.$l.find(t);if(o!==null){let i=G.getEnv(),c=this.$borrowClassHandle(i);try{n=Xd(t,o,c.value,this.$w,i)}finally{c.unref(i)}return e.set(t,n),n}let s=this.$s;return s!==null?s.$find(t):null}},$find:{value(t){return this[Symbol.for("find")](t)}},[Symbol.for("toJSON")]:{enumerable:!1,value(){let t=this.$n;if(this.$h===null)return`<class: ${t}>`;let n=this.$className;return t===n?`<instance: ${t}>`:`<instance: ${t}, $className: ${n}>`}},toJSON:{get(){return this[Symbol.for("toJSON")]}}});function mr(t,e){this.value=e.newGlobalRef(t),e.deleteLocalRef(t),this.refs=1}mr.prototype.ref=function(){return this.refs++,this};mr.prototype.unref=function(t){--this.refs===0&&t.deleteGlobalRef(this.value)};function Wd(t,e){t.unref(e)}function qd(t){let e=t.replace(/\./g,"/");return function(n){let r=Bt();ns(r);try{return n.findClass(e)}finally{rs(r)}}}function Kd(t,e,n){return cr===null&&(Go=n.vaMethod("pointer",["pointer"]),cr=e.loadClass.overload("java.lang.String").handle),n=null,function(r){let o=r.newStringUtf(t),s=Bt();ns(s);try{let i=Go(r.handle,e.$h,cr,o);return r.throwIfExceptionPending(),i}finally{rs(s),r.deleteLocalRef(o)}}}function Qd(t){return function(e){let n=t.$borrowClassHandle(e);try{return e.getSuperclass(n.value)}finally{n.unref(e)}}}function Yd(t,e,n){let{$n:r,$f:o}=e,s=fu(r),i=n.javaLangClass(),c=n.javaLangReflectConstructor(),a=n.vaMethod("pointer",[]),l=n.vaMethod("uint8",[]),d=[],p=[],f=o._getType(r,!1),u=o._getType("void",!1),_=a(n.handle,t,i.getDeclaredConstructors);try{let h=n.getArrayLength(_);if(h!==0)for(let g=0;g!==h;g++){let b,S,I=n.getObjectArrayElement(_,g);try{b=n.fromReflectedMethod(I),S=a(n.handle,I,c.getGenericParameterTypes)}finally{n.deleteLocalRef(I)}let A;try{A=hr(n,S).map(k=>o._getType(k))}finally{n.deleteLocalRef(S)}d.push(Ke(s,e,lr,b,f,A,n)),p.push(Ke(s,e,Ae,b,u,A,n))}else{if(l(n.handle,t,i.isInterface))throw new Error("cannot instantiate an interface");let b=n.javaLangObject(),S=n.getMethodId(b,"<init>","()V");d.push(Ke(s,e,lr,S,f,[],n)),p.push(Ke(s,e,Ae,S,u,[],n))}}finally{n.deleteLocalRef(_)}if(p.length===0)throw new Error("no supported overloads");return{allocAndInit:ur(d),initOnly:ur(p)}}function Xd(t,e,n,r,o){return e.startsWith("m")?eu(t,e,n,r,o):lu(t,e,n,r,o)}function eu(t,e,n,r,o){let{$f:s}=r,i=e.split(":").slice(1),c=o.javaLangReflectMethod(),a=o.vaMethod("pointer",[]),l=o.vaMethod("uint8",[]),d=i.map(f=>{let u=f[0]==="s"?_t:Ae,_=ptr(f.substr(1)),h,g=[],b=o.toReflectedMethod(n,_,u===_t?1:0);try{let S=!!l(o.handle,b,c.isVarArgs),I=a(o.handle,b,c.getGenericReturnType);o.throwIfExceptionPending();try{h=s._getType(o.getTypeName(I))}finally{o.deleteLocalRef(I)}let A=a(o.handle,b,c.getParameterTypes);try{let k=o.getArrayLength(A);for(let M=0;M!==k;M++){let N=o.getObjectArrayElement(A,M),P;try{P=S&&M===k-1?o.getArrayTypeName(N):o.getTypeName(N)}finally{o.deleteLocalRef(N)}let E=s._getType(P);g.push(E)}}finally{o.deleteLocalRef(A)}}catch{return null}finally{o.deleteLocalRef(b)}return Ke(t,r,u,_,h,g,o)}).filter(f=>f!==null);if(d.length===0)throw new Error("No supported overloads");t==="valueOf"&&iu(d);let p=ur(d);return function(f){return p}}function ur(t){let e=tu();return Object.setPrototypeOf(e,Qo),e._o=t,e}function tu(){let t=function(){return t.invoke(this,arguments)};return t}Qo=Object.create(Function.prototype,{overloads:{enumerable:!0,get(){return this._o}},overload:{value(...t){let e=this._o,n=t.length,r=t.join(":");for(let o=0;o!==e.length;o++){let s=e[o],{argumentTypes:i}=s;if(i.length!==n)continue;if(i.map(a=>a.className).join(":")===r)return s}pr(this.methodName,this.overloads,"specified argument types do not match any of:")}},methodName:{enumerable:!0,get(){return this._o[0].methodName}},holder:{enumerable:!0,get(){return this._o[0].holder}},type:{enumerable:!0,get(){return this._o[0].type}},handle:{enumerable:!0,get(){return Ve(this),this._o[0].handle}},implementation:{enumerable:!0,get(){return Ve(this),this._o[0].implementation},set(t){Ve(this),this._o[0].implementation=t}},returnType:{enumerable:!0,get(){return Ve(this),this._o[0].returnType}},argumentTypes:{enumerable:!0,get(){return Ve(this),this._o[0].argumentTypes}},canInvokeWith:{enumerable:!0,get(t){return Ve(this),this._o[0].canInvokeWith}},clone:{enumerable:!0,value(t){return Ve(this),this._o[0].clone(t)}},invoke:{value(t,e){let n=this._o,r=t.$h!==null;for(let o=0;o!==n.length;o++){let s=n[o];if(s.canInvokeWith(e)){if(s.type===Ae&&!r){let i=this.methodName;if(i==="toString")return`<class: ${t.$n}>`;throw new Error(i+": cannot call instance method without an instance")}return s.apply(t,e)}}if(this.methodName==="toString")return`<class: ${t.$n}>`;pr(this.methodName,this.overloads,"argument types do not match any of:")}}});function $o(t,e,n){return`${e.className} ${t}(${n.map(r=>r.className).join(", ")})`}function Ve(t){let e=t._o;e.length>1&&pr(e[0].methodName,e,"has more than one overload, use .overload(<signature>) to choose from:")}function pr(t,e,n){let o=e.slice().sort((s,i)=>s.argumentTypes.length-i.argumentTypes.length).map(s=>s.argumentTypes.length>0?".overload('"+s.argumentTypes.map(c=>c.className).join("', '")+"')":".overload()");throw new Error(`${t}(): ${n}
	${o.join(`
	`)}`)}function Ke(t,e,n,r,o,s,i,c){let a=o.type,l=s.map(f=>f.type);i===null&&(i=G.getEnv());let d,p;return n===Ae?(d=i.vaMethod(a,l,c),p=i.nonvirtualVaMethod(a,l,c)):n===_t?(d=i.staticVaMethod(a,l,c),p=d):(d=i.constructor(l,c),p=d),nu([t,e,n,r,o,s,d,p])}function nu(t){let e=ru();return Object.setPrototypeOf(e,Yo),e._p=t,e}function ru(){let t=function(){return t.invoke(this,arguments)};return t}Yo=Object.create(Function.prototype,{methodName:{enumerable:!0,get(){return this._p[0]}},holder:{enumerable:!0,get(){return this._p[1]}},type:{enumerable:!0,get(){return this._p[2]}},handle:{enumerable:!0,get(){return this._p[3]}},implementation:{enumerable:!0,get(){let t=this._r;return t!==void 0?t:null},set(t){let e=this._p,n=e[1];if(e[2]===lr)throw new Error("Reimplementing $new is not possible; replace implementation of $init instead");let o=this._r;if(o!==void 0&&(n.$f._patchedMethods.delete(this),o._m.revert(G),this._r=void 0),t!==null){let[s,i,c,a,l,d]=e,p=es(s,i,c,l,d,t,this),f=Zo(a);p._m=f,this._r=p,f.replace(p,c===Ae,d,G,K),n.$f._patchedMethods.add(this)}}},returnType:{enumerable:!0,get(){return this._p[4]}},argumentTypes:{enumerable:!0,get(){return this._p[5]}},canInvokeWith:{enumerable:!0,value(t){let e=this._p[5];return t.length!==e.length?!1:e.every((n,r)=>n.isCompatible(t[r]))}},clone:{enumerable:!0,value(t){let e=this._p.slice(0,6);return Ke(...e,null,t)}},invoke:{value(t,e){let n=G.getEnv(),r=this._p,o=r[2],s=r[4],i=r[5],c=this._r,a=o===Ae,l=e.length,d=2+l;n.pushLocalFrame(d);let p=null;try{let f;a?f=t.$getHandle():(p=t.$borrowClassHandle(n),f=p.value);let u,_=t.$t;c===void 0?u=r[3]:(u=c._m.resolveTarget(t,a,n,K),qo&&c._c.has(Bt())&&(_=Wo));let h=[n.handle,f,u];for(let S=0;S!==l;S++)h.push(i[S].toJni(e[S],n));let g;_===Dt?g=r[6]:(g=r[7],a&&h.splice(2,0,t.$copyClassHandle(n)));let b=g.apply(null,h);return n.throwIfExceptionPending(),s.fromJni(b,n,!0)}finally{p!==null&&p.unref(n),n.popLocalFrame(NULL)}}},toString:{enumerable:!0,value(){return`function ${this.methodName}(${this.argumentTypes.map(t=>t.className).join(", ")}): ${this.returnType.className}`}}});function es(t,e,n,r,o,s,i=null){let c=new Set,a=ou([t,e,n,r,o,s,i,c]),l=new NativeCallback(a,r.type,["pointer","pointer"].concat(o.map(d=>d.type)));return l._c=c,l}function ou(t){return function(){return su(arguments,t)}}function su(t,e){let n=new y(t[0],G),[r,o,s,i,c,a,l,d]=e,p=[],f;if(s===Ae){let h=o.$C;f=new h(t[1],Dt,n,!1)}else f=o;let u=Bt();n.pushLocalFrame(3);let _=!0;G.link(u,n);try{d.add(u);let h;l===null||!Qe.has(u)?h=a:h=l;let g=[],b=t.length-2;for(let A=0;A!==b;A++){let M=c[A].fromJni(t[2+A],n,!1);g.push(M),p.push(M)}let S=h.apply(f,g);if(!i.isCompatible(S))throw new Error(`Implementation for ${r} expected return value compatible with ${i.className}`);let I=i.toJni(S,n);return i.type==="pointer"&&(I=n.popLocalFrame(I),_=!1,p.push(S)),I}catch(h){let g=h.$h;return g!==void 0?n.throw(g):Script.nextTick(()=>{throw h}),i.defaultValue}finally{G.unlink(u),_&&n.popLocalFrame(NULL),d.delete(u),p.forEach(h=>{if(h===null)return;let g=h.$dispose;g!==void 0&&g.call(h)})}}function iu(t){let{holder:e,type:n}=t[0];t.some(o=>o.type===n&&o.argumentTypes.length===0)||t.push(au([e,n]))}function au(t){let e=cu();return Object.setPrototypeOf(e,Xo),e._p=t,e}function cu(){return function(){return this}}Xo=Object.create(Function.prototype,{methodName:{enumerable:!0,get(){return"valueOf"}},holder:{enumerable:!0,get(){return this._p[0]}},type:{enumerable:!0,get(){return this._p[1]}},handle:{enumerable:!0,get(){return NULL}},implementation:{enumerable:!0,get(){return null},set(t){}},returnType:{enumerable:!0,get(){let t=this.holder;return t.$f.use(t.$n)}},argumentTypes:{enumerable:!0,get(){return[]}},canInvokeWith:{enumerable:!0,value(t){return t.length===0}},clone:{enumerable:!0,value(t){throw new Error("Invalid operation")}}});function lu(t,e,n,r,o){let s=e[2]==="s"?ar:dr,i=ptr(e.substr(3)),{$f:c}=r,a,l=o.toReflectedField(n,i,s===ar?1:0);try{a=o.vaMethod("pointer",[])(o.handle,l,o.javaLangReflectField().getGenericType),o.throwIfExceptionPending()}finally{o.deleteLocalRef(l)}let d;try{d=c._getType(o.getTypeName(a))}finally{o.deleteLocalRef(a)}let p,f,u=d.type;return s===ar?(p=o.getStaticField(u),f=o.setStaticField(u)):(p=o.getField(u),f=o.setField(u)),du([s,d,i,p,f])}function du(t){return function(e){return new ts([e].concat(t))}}function ts(t){this._p=t}Object.defineProperties(ts.prototype,{value:{enumerable:!0,get(){let[t,e,n,r,o]=this._p,s=G.getEnv();s.pushLocalFrame(4);let i=null;try{let c;if(e===dr){if(c=t.$getHandle(),c===null)throw new Error("Cannot access an instance field without an instance")}else i=t.$borrowClassHandle(s),c=i.value;let a=o(s.handle,c,r);return s.throwIfExceptionPending(),n.fromJni(a,s,!0)}finally{i!==null&&i.unref(s),s.popLocalFrame(NULL)}},set(t){let[e,n,r,o,,s]=this._p,i=G.getEnv();i.pushLocalFrame(4);let c=null;try{let a;if(n===dr){if(a=e.$getHandle(),a===null)throw new Error("Cannot access an instance field without an instance")}else c=e.$borrowClassHandle(i),a=c.value;if(!r.isCompatible(t))throw new Error(`Expected value compatible with ${r.className}`);let l=r.toJni(t,i);s(i.handle,a,o,l),i.throwIfExceptionPending()}finally{c!==null&&c.unref(i),i.popLocalFrame(NULL)}}},holder:{enumerable:!0,get(){return this._p[0]}},fieldType:{enumerable:!0,get(){return this._p[1]}},fieldReturnType:{enumerable:!0,get(){return this._p[2]}},toString:{enumerable:!0,value(){let t=`Java.Field{holder: ${this.holder}, fieldType: ${this.fieldType}, fieldReturnType: ${this.fieldReturnType}, value: ${this.value}}`;return t.length<200?t:`Java.Field{
	holder: ${this.holder},
