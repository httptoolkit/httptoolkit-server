(() => {
  ...
  var require_content_script = __commonJS({
    "src/content-script.ts"(exports) {
      init_virtual_process_polyfill();
      init_buffer();
      var import_webextension_polyfill = __toESM(require_browser_polyfill());
      var script = document.createElement("script");
      script.src = import_webextension_polyfill.runtime.getURL("/build/injected-script.js");
      document.documentElement.appendChild(script);
      document.addEventListener("htk-extension:sw-message", (event) => __async(exports, null, function* () {
        const { id, requestJson } = event.detail;
        const request = JSON.parse(requestJson);
        try {
          const response = yield import_webextension_polyfill.runtime.sendMessage(request);
          document.dispatchEvent(new CustomEvent(`htk-extension:sw-response:${id}`, {
            detail: response
          }));
        } catch (e) {
